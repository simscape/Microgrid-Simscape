...
if ~exist('h3_remote_microgrid', 'var') || ...
        ~isgraphics(h3_remote_microgrid, 'figure')
    h3_remote_microgrid = figure('Name', 'remote_microgrid');
end
figure(h3_remote_microgrid)
clf(h3_remote_microgrid)


plotRemoteMicrogridPQ(logsout_remote_microgrid)

%function plotRemoteMicrogridPQ

function plotRemoteMicrogridPQ(logsout)
